...
var C = "https://api.d-id.com";
var B = "wss://notifications.d-id.com";
function U(e) {
  if (e.type === "bearer")
...
var V = (e) => new Promise((i) => setTimeout(i, e));
function G(e) {
...
var Y = ((e) => (e.Amazon = "amazon", e.Microsoft = "microsoft", e.Afflorithmics = "afflorithmics", e.Elevenlabs = "elevenlabs", e))(Y || {});
var Z = ((e) => (e.Public = "public", e.Premium = "premium", e.Private = "private", e))(Z || {});
var _ = ((e) => (e.Start = "START", e.Stop = "STOP", e))(_ || {});
var A = ((e) => (e.ChatAnswer = "chat/answer", e.ChatPartial = "chat/partial", e.StreamDone = "stream/done", e.StreamStarted = "stream/started", e))(A || {});
var O = ((e) => (e.Unrated = "Unrated", e.Positive = "Positive", e.Negative = "Negative", e))(O || {});
var j = ((e) => (e.Functional = "Functional", e.TextOnly = "TextOnly", e.Maintenance = "Maintenance", e))(j || {});
var K = ((e) => (e.Embed = "embed", e.Query = "query", e.Partial = "partial", e.Answer = "answer", e.Complete = "done", e))(K || {});
var ee = ((e) => (e.KnowledgeProcessing = "knowledge/processing", e.KnowledgeIndexing = "knowledge/indexing", e.KnowledgeFailed = "knowledge/error", e.KnowledgeDone = "knowledge/done", e))(ee || {});
var te = ((e) => (e.Knowledge = "knowledge", e.Document = "document", e.Record = "record", e))(te || {});
var ne = ((e) => (e.Pdf = "pdf", e.Text = "text", e.Html = "html", e.Word = "word", e.Json = "json", e.Markdown = "markdown", e.Csv = "csv", e.Excel = "excel", e.Powerpoint = "powerpoint", e.Archive = "archive", e.Image = "image", e.Audio = "audio", e.Video = "video", e))(ne || {});
var R = ((e) => (e.Clip = "clip", e.Talk = "talk", e))(R || {});
function re(e) {
...
var T = false;
var v = (e, i) => T && console.log(e, i);
var oe = (window.RTCPeerConnection || window.webkitRTCPeerConnection || window.mozRTCPeerConnection).bind(window);
async function ce(e, {
  debug: i = false,
  callbacks: r,
  auth: t,
